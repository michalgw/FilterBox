  ...
  If (Not PSCIsDelphiRunning) Then
    Begin
      windows.MessageBox(0,
        'This application uses unregistered version of puterSoft.Com product'#13#10 + //don't resource
        'Please register. Visit www.putersoft.com for details.' //don't resource
...
begin
  Result:=SysUtils.DayOfWeek(ADate);
end;
...
function TPSCExternalProcs.IncMonth(const ADate: TDateTime;
  ANumberOfMonths: Integer = 1): TDateTime;
begin
  Result:=SysUtils.IncMonth(ADate,ANumberOfMonths);
end;
