...
{  folder of the puterSoft.SDK package.                                     }
{                                                                           }
...
begin
  ...
  begin
    ...
    begin
      ...
      YearEdit.Height := HeaderHeight - 2;
    end;
  ...
  With Canvas Do
    Begin
      ...
      Try
        ...
        With Rect Do
          Canvas.TextRect(Rect,(Right + Left - Size.cx) Div 2,
          ...
          Begin
            For I := 0 To 6 Do
              Begin
                ...
                MyPoint.X:=Left+ (Right - Left - Size.cx) Div 2;
                MyPoint.Y:=Top + (Bottom - Top - Size.cy) Div 2;

                AlignDayName(R,Size,MyPoint);
...
Begin
  ...
  FSelectedColor := cPSCDefMonthsSelectedColor;
  FSelectedTextColor := clPSCWindowText;
  ...
  With Rect Do
    Case Area Of
      ...
      mhtCaption:
        Begin
          Top := Delta;
          Bottom := Top + Size.cy + 4
        End;
      mhtMonths: Top := Delta + Size.cy + 4;
      mhtLeftArrow:
        Begin
          Left := 0;
          Top := 0;
      ...
      mhtYear:
        Begin
          Right := Right Div 2;
          Left := Right - Size.cx * 3;
          Right := Right + Size.cx * 3;
          Bottom := Delta;
        End;
      mhtMonth:
    ...
    Begin
      ...
      Try
        ...
        Try
          ...
          With Rect Do
            Canvas.TextRect(Rect,(Right + Left - Size.cx) Div 2 + Delta,
              (Top + Bottom - Size.cy) Div 2 + Delta,S);
  ...
  With Canvas Do
    Begin
      ...
      Try
        ...
        With Rect Do
          Canvas.TextRect(Rect,(Right + Left - Size.cx) Div 2,
            (Top + Bottom - Size.cy) Div 2,Caption);
      Finally
        Font.Color := TextColor;
        Brush.Color := Color
      End
