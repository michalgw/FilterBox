...
{    Property BevelInner;
  ...
  private
    ...
    Procedure UpdateCanvasFormatting(const ACanvas:IPSCCanvas);
  protected
  ...
  public
    ...
    Procedure UpdateFormatting(const ACanvas:IPSCCanvas=nil;const AFieldName:String='');
...
Procedure TPSCGridColors.UpdateCanvasFormatting(const ACanvas:IPSCCanvas);
    ...
    If AOption in FormatOptions then
      begin
        If AFontStyle in FormatFontStyle then
          ACanvas.Font.Style:=ACanvas.Font.Style+[AFontStyle]
        else
          ACanvas.Font.Style:=ACanvas.Font.Style-[AFontStyle];
      end;
  end;
...
Procedure TPSCGridColors.UpdateFormatting(const ACanvas:IPSCCanvas=nil;
