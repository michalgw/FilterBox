      ...
      DTFPK_YEAR_IN_ERA:
        begin
          If Style=DTFPS_ZERO then
            S:=DateTimeFormat.ToString(GetDateTime,'ee')
          else
            S:=DateTimeFormat.ToString(GetDateTime,'e');
          AddPart_Delimeter(S,dtpSeparator);
        end;
      DTFPK_ERA:
        begin
          If Style=DTFPS_ZERO then
            S:=DateTimeFormat.ToString(GetDateTime,'gg')
          else
            S:=DateTimeFormat.ToString(GetDateTime,'g');
          AddPart_Delimeter(S,dtpSeparator);
        end;
      DTFPK_DAY:
        AddPart_Day(APart);
