...
begin
  ...
  Case DataType Of
    FT_DATETIME:
      Result := DateTimeFormat.ToString(MyDateTime,cpkDateTime);
    FT_DATE:
      Result := DateTimeFormat.ToString(MyDateTime,cpkDate);
    FT_TIME:
      Result := DateTimeFormat.ToString(MyDateTime,cpkTime);
