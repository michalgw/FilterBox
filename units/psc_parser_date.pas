...
Function TPSCDateTimeFormat.ToString(Const V: TDateTime;AKind:TPSCDateTimeKind): String;
var
  MyFormat:String;
...
begin
  ...
  Result:=ToString(MyDateTime,MyFormat);
end;

{------------------------------------------------------------------------------}

Function TPSCDateTimeFormat.ToString(Const V: TDateTime;
  const AFormat:String): String;
var
